...
async function callHuggingFaceAPI(audioBuffer: ArrayBuffer): Promise<string | null> {
  try {
    console.log('🎵 Calling Hugging Face LP-MusicCaps API...');
    ...
    if (result.generated_text) {
      console.log('✅ Music caption generated successfully');
...
async function convertToWav(audioFile: File): Promise<ArrayBuffer> {
  try {
    ...
    console.log('✅ Audio buffer prepared:', arrayBuffer.byteLength, 'bytes');
    return arrayBuffer;
...
export async function POST(request: NextRequest) {
  console.log('🎵 Hugging Face music analysis API called');
  ...
  try {
    ...
    if (audioFile.size > maxSize) {
      console.error('❌ File too large for AI analysis:', audioFile.size);
